...
public class CustomExceptionHandler {
    ...
    public ErrorResponse HandleItemNotFoundException(IdNotFoundException e) {
        ...
        var error = Error.builder().errorCode("NotFound").message(e.getMessage()).build();
        return ErrorResponse.builder().code(HttpStatus.NOT_FOUND.toString()).errors(errors).build();
    }
